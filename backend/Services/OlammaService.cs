namespace Back_HR.Services
{
    ...
    public class OllamaService
    {
        ...
        public async Task<string> GetResponseAsync(string prompt, string model = "llama2")
        {
            var request = new
            {
                model,
        ...
        public async IAsyncEnumerable<string> GetStreamingResponseAsync(string prompt, string model = "llama2")
        {
            var request = new
            {
                model,
